############### CODE BY FILIPE RODRIGUES: http://fprodrigues.com/publications/deep-crowds/-- thanks for the platform!
import numpy as np
...
from .learning_models import UnitSum
...
class CrowdsAggregationBinaryCrossEntropy(object):
	...
	def __init__(self, num_annotators, pi_prior=0.01, alpha=None, beta=None, update_freq=1):
		...
		self.suff_stats_alpha_norm = [self.pi_prior for r in xange(self.num_annotators)]
